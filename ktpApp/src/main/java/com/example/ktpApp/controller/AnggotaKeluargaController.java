...
public class AnggotaKeluargaController {
	...
	@PostMapping("/insertAnggotaKeluarga")
	public AnggotaKeluarga insertKartuKeluarga(@RequestBody AnggotaKeluarga anggotaKeluarga) {
		return anggotaKeluargaService.insertAnggotaKeluarga(anggotaKeluarga);
	}
	
	@GetMapping("/getAllAnggotaKeluarga")
	public List<AnggotaKeluarga> getAllAnggotaKeluarga() {
		return anggotaKeluargaService.getAllAnggotaKeluarga();
	}
	
	@PutMapping("/updateAnggotaKeluarga/{id}")
	...
	@DeleteMapping("/deleteAnggotaKeluarga/{id}")
	...
	public AnggotaKeluarga getAnggotaId(@PathVariable int id) {
		return anggotaKeluargaService.getAnggotaId(id);
	}
